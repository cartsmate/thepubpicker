function populate_summary(id) {
    ...
    document.getElementById('summary_name').innerHTML = "<a style='font-family: Verdana, sans-serif; text-align: center; text-decoration: none; font-size: 12px; font-weight: bold;'>" + text_ref + "</a>"
