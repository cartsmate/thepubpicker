function marker_add_collection(map, pub_filtered) {
    console.log('ADD_MARKERS_MULTI')
//    console.log('data')
//    console.log(data)
    /*
...
//    markersArray = []
    ...
    for (var i = 0; i < pub_filtered.length; i++) {
//    for (var key in pub) {
//        console.log('key')
//        console.log(key)
        //console.log('data')
...
//        };
        ...
        */
        ...
        marker = new google.maps.Marker({
            position: new google.maps.LatLng(pub_filtered[i].detail_latitude, pub_filtered[i].detail_longitude),
            map: map,
            icon: markerImage
        })
...
//        google.maps.event.addListener(marker, 'click', (function (marker, key) {
//            return function () {
//                console.log('add_markers_multi - listener click')
...
//                click_direction(pub[key].direction_identity.toString())
//                }
//            })(marker, key))
        /*
        google.maps.event.addListener(marker, 'click', (function (marker, key) {
...
//        markersArray.push(marker);
        var myLatLng = new google.maps.LatLng(pub_filtered[i].detail_latitude, pub_filtered[i].detail_longitude)
