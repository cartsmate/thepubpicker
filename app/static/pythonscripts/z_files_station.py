...
# class FilesStation:
    ...
    # def get_station_all(self):
    #     df_station = GetPub().get_all(Station())
    ...
    #     df_1_station = GetPub().get_1(Station(), pub_id)
    ...
    #     df_station = AddPub().add_pub(Station(), pub_id)
    ...
    #     # df_station = pd.DataFrame([new_station.__dict__])
    #     return df_station
