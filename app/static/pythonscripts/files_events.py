...
class FilesEvent:
    ...
    def new_event(self, pub_id, event_id):
        ...
        df_new_event = pd.DataFrame([new_event.__dict__])
        return df_new_event
    ...
    def form_event(self):
        ...
        df_new_event = pd.DataFrame([new_event.__dict__])
        newdf1 = df_new_event.transpose()
        print(newdf1)
        return df_new_event

    def update_event_df(self, df_events, event_id):
