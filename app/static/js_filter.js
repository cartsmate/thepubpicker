...
hide_filters()}
function toggle_filters(){var button_direction=document.getElementById('button_direction')
...
button_direction.addEventListener("click",function(){if(content_direction.style.display==="none"){content_direction.style.display="flex";content_station.style.display="none"
content_diary.style.display="none"
content_feature.style.display="none"
content_event.style.display="none"
content_pub_identity.style.display="none"}else{content_direction.style.display="none"}})
button_station.addEventListener("click",function(){if(content_station.style.display==="none")
{content_station.style.display="flex";content_direction.style.display="none"
content_feature.style.display="none"
content_diary.style.display="none"
content_event.style.display="none"
content_pub_identity.style.display="none"}else{content_station.style.display="none"}});button_feature.addEventListener("click",function(){if(content_feature.style.display==="none"){content_feature.style.display="flex";content_direction.style.display="none"
content_station.style.display="none"
content_diary.style.display="none"
content_event.style.display="none"
content_pub_identity.style.display="none"}else{content_feature.style.display="none"}})
button_diary.addEventListener("click",function(){if(content_diary.style.display==="none"){content_diary.style.display="flex";content_direction.style.display="none"
content_station.style.display="none"
content_feature.style.display="none"
content_event.style.display="none"
content_pub_identity.style.display="none"}else{content_diary.style.display="none"}})
button_event.addEventListener("click",function(){if(content_event.style.display==="none"){content_event.style.display="flex";content_direction.style.display="none"
content_station.style.display="none"
content_feature.style.display="none"
content_diary.style.display="none"
content_pub_identity.style.display="none"}else{content_event.style.display="none"}})
button_pub_identity.addEventListener("click",function(){if(content_pub_identity.style.display==="none"){content_pub_identity.style.display="flex";content_direction.style.display="none"
content_station.style.display="none"
content_feature.style.display="none"
content_diary.style.display="none"
content_event.style.display="none"}else{content_pub_identity.style.display="none"}})
