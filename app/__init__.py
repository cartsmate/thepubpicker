...
js = Bundle([f"{dirname}/static/javascript/urgent/display_counter.js",
             ...
             f"{dirname}/static/javascript/onload/onload.js"],
            output='main.js',
            filters='jsmin')

js_defer = Bundle([f"{dirname}/static/javascript/defer/spinner_set_css_classes.js",
                   f"{dirname}/static/javascript/defer/spinner_set_css_classes_flat.js",
                   f"{dirname}/static/javascript/defer/get_filter_values.js",
                   f"{dirname}/static/javascript/defer/on_click.js",
                   f"{dirname}/static/javascript/defer/populate_header.js"],
                  output='main_defer.js',
                  filters='jsmin')
...
# assets.register('main_defer.js', js_defer)
# js_defer.build()
