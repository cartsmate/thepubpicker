...
class ReviewIdentity:
    def __init__(self, name='review_identity', alias="Review Identity", alias2="", required=False,
                 form_visible=False, table_visible=False, value=UuidGenerator().get_new_uuid(), control='none',
                 icon='none', data_type='str', menu_filter=False, quick_filter=False, event_filter=False,
                 datatype='str'):
        self.name = name
        self.alias = alias
        self.alias2 = alias2
